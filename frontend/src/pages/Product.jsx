...
import { toast } from 'react-toastify'; // Import react-toastify for the notification
...
const Product = () => {
  ...
  const handleAddToCart = () => {
    // Only check for size if the product category is "Clothing"
    ...
    // Proceed to add to cart for all products
    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          {/* Display Size Options only for Clothing */}
